    <!-- SVG CAROUSEL -->
    <svg class="waves" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 214.5" preserveAspectRatio="xMinYMid meet" style="width: 100%; height: 40vh;">
        <defs>
            <style>
                .waves>path {
    ...
    <!-- <svg class="text" xmlns="http://www.w3.org/2000/svg" width="1440" height="321.75" viewBox="0 0 1440 321.8" preserveAspectRatio="xMidYMid meet" aria-label="Plan Every Event With Perfect Gift."> -->

    <div class="col-md-5 col-lg-5" style="padding-left: 10%;">
        <h1 class="display-5" style="margin-top: -30vh;">Plan Every event with Perfect Gift.</h1>
        <p style="margin-top: -10px; color: #C499CA;">Best wholesale Customizable Corporate Gifts.</p>
        <a href="#"><button class="btn btn-danger" style="margin-top: -10px; margin-bottom: 10vh;">Shop Now</button></a>
    </div>
    <!-- SVG CAROUSEL END -->